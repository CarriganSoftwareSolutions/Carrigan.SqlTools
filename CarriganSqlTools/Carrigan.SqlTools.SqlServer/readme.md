...
In addition, the library handles decryption of encrypted fields when encryption logic has been defined through the interfaces and attributes provided by **Carrigan.Core**.  
...
- **Encryption support**  
  Decrypt fields that use encryption logic defined through interfaces and attributes in **Carrigan.Core**.  
