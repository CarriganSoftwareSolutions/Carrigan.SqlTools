...
public static class CustomerDataSet
{
    ...
    public static void ValidateAtIndex(IEnumerable<Customer> actualCustomers, int index, int? expectedId)
    {
        Customer actual = actualCustomers.ElementAt(index);
    ...
    public static void ValidateByIndexRange(IEnumerable<Customer> actualCustomers, int indexFirst, int indexLast, int expectedId)
    {
        for (int index = indexFirst; index <= indexLast; index++)
        {
            ValidateAtIndex(actualCustomers, index, expectedId);
        }
    }

    public static void Validate(Customer actual, int? expectedId)
    {
        ...
        {
            Customer expected = Data.Where(customer => customer.Id == expectedId).Single();
