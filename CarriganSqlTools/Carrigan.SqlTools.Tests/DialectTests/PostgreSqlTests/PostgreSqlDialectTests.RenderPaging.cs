...
public partial class PostgreSqlDialectTests
{
    ...
    {
        string actual = Dialect.RenderPaging(new OffsetFetchNext(0, 0)).ToSql();
    ...
    {
        string actual = Dialect.RenderPaging(new OffsetFetchNext(0, 25)).ToSql();
    ...
    {
        string actual = Dialect.RenderPaging(new OffsetFetchNext(25, 0)).ToSql();
    ...
    {
        string actual = Dialect.RenderPaging(new OffsetFetchNext(25, 10)).ToSql();
