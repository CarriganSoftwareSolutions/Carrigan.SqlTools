...
public class ParameterNameTests
{
    ...
    {
        ParameterName nameWrapper = new (nul);
    ...
    {
        ParameterName? nameWrapper = ParameterName.New(nul);
    ...
    {
        ParameterName? nameWrapper = ParameterName.New(empty);
        Assert.Null(nameWrapper);
    }
    ...
    {
        ParameterName? nameWrapper = ParameterName.New(white);
        Assert.NotNull(nameWrapper);
    }
    ...
    {
        ParameterName nameWrapper = new(empty);
    ...
    {
        ParameterName nameWrapper = new(eStr);
    ...
    public void Equal_Null()
    {
        ...
        ParameterName nameWrapper1 = new(name);
        ParameterName nameWrapper2 = new(name);
    ...
    {
        ParameterName nameWrapper1 = new(eStr);
        ParameterName nameWrapper2 = new(eStrAlt);
        Assert.Equal(nameWrapper1, nameWrapper2);
    ...
    {
        ParameterName nameWrapper1 = new(nul);
        ParameterName nameWrapper2 = new(nul);
    ...
    {
        ParameterName nameWrapper1 = new(empty);
        ParameterName nameWrapper2 = new(empty);
        Assert.True(nameWrapper1 == nameWrapper2);
        Assert.True(string.Empty == nameWrapper2);
    }
    ...
    {
        ParameterName nonNull = new(string.Empty);
        ParameterName? isNull = null;
    ...
    {
        string? name = null;
        Dictionary<ParameterName, decimal> dictionary= [];
    ...
    public void DictionaryKey_Multi()
    {
        ...
        ParameterName nameWrapper1 = new(eStr);
        ParameterName nameWrapper2 = new(eStrAlt);
        ParameterName nameWrapper3 = new(tString);
        ParameterName nameWrapper4 = new(goldenString);
        ParameterName nameWrapper5 = new(piString);
        ParameterName nameWrapper6 = new(empty);
    ...
    {
        ParameterName nameWrapper1 = new(nul);
        ParameterName nameWrapper2 = new(goldenString);
    ...
    {
        ParameterName nameWrapper1 = new(nul);
        ParameterName nameWrapper2 = new(eStr);
        Assert.True(nameWrapper1 != nameWrapper2);
    ...
    public void IsNullOrEmpty_True()
    {
        ParameterName? nameWrapper1 = new(empty);
        ParameterName nameWrapper2 = new(nul);
        ParameterName? nameWrapper3 = null;
        ParameterName? nameWrapper4 = ParameterName.New(nul);
        ParameterName? nameWrapper5 = ParameterName.New(empty);
    ...
    {
        ParameterName nameWrapper1 = new(eStr);
        ParameterName nameWrapper2 = new(white);
    ...
    public void IsNullOrEmpty_False()
    {
        ParameterName nameWrapper1 = new(eStr);
        ParameterName nameWrapper2 = new(white);
        ParameterName? nameWrapper3 = ParameterName.New(eStr);
        ParameterName? nameWrapper4 = ParameterName.New(white);
    ...
    public void IsNotNullOrEmpty_False()
    {
        ...
        ParameterName nameWrapper2 = new(nul);
        ParameterName? nameWrapper3 = null;
        ParameterName? nameWrapper4 = ParameterName.New(null);
        ParameterName? nameWrapper5 = ParameterName.New(nul);
        ParameterName? nameWrapper6 = ParameterName.New(empty);
    ...
    public void IsWhitespace_True()
    {
        ParameterName nameWrapper1 = new(empty);
        ParameterName nameWrapper2 = new(nul);
        ParameterName nameWrapper3 = new(white);
    ...
    public void IsNullOrWhitespace_True()
    {
        ...
        ParameterName nameWrapper2 = new(nul);
        ParameterName nameWrapper3 = new(white);
        ParameterName? nameWrapper4 = null;
        ParameterName? nameWrapper5 = ParameterName.New(null);
        ParameterName? nameWrapper6 = ParameterName.New(nul);
        ParameterName? nameWrapper7 = ParameterName.New(empty);
        ParameterName? nameWrapper8 = ParameterName.New(white);
    ...
    {
        ParameterName nameWrapper1 = new(eStr);
        ParameterName? nameWrapper2 = ParameterName.New(eStr);
    ...
    public void IsNotNullOrWhitespace_False()
    {
        ...
        ParameterName? nameWrapper5 = ParameterName.New(empty);
        ParameterName? nameWrapper6 = ParameterName.New(nul);
        ParameterName? nameWrapper7 = ParameterName.New(white);
    ...
    {
        ParameterName nameWrapper1 = new(eStr);
        object nameWrapper2 = new ParameterName(eStr);
