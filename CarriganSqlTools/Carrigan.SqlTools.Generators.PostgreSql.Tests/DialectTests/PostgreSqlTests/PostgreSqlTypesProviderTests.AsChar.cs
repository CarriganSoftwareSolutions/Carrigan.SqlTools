...
public partial class PostgreSqlTypesProviderTests
{
    ...
    {
        FieldProperties actual = PostgreSqlTypesProvider.AsChar(10, false);
    ...
    {
        FieldProperties actual = PostgreSqlTypesProvider.AsChar(null, false);
    ...
    {
        FieldProperties actual = PostgreSqlTypesProvider.AsChar(10, false, true);
    ...
    {
        FieldProperties actual = PostgreSqlTypesProvider.AsChar(null, false, true);
    ...
    public void AsChar_InvalidLength_Exception(int length) => 
        Assert.Throws<ArgumentOutOfRangeException>(() => PostgreSqlTypesProvider.AsChar(length, false));
}
