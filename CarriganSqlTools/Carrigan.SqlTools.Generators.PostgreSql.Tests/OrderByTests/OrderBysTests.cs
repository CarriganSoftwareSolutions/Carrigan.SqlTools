...
public class OrderBysTests
{
    ...
    {
        IEnumerable<OrderBy>? orderByItems = null;
    ...
    public void OrderByItemBasesAsEnumerable_ReturnsItemsInOrder()
    {
        ...
        List<OrderBy> orderByItems = [.. orderBy.AsEnumerable()];
        List<OrderBy> expectedOrderByItems = [city, street];
    ...
    public void Concat_AppendsItemsInOrderWithoutMutatingOriginal()
    {
        ...
        OrderBy[] additionalItems = [street, columnTable];

        OrderBys appended = original.Concat(additionalItems);

        List<OrderBy> originalItems = [.. original.AsEnumerable()];
        List<OrderBy> appendedItems = [.. appended.AsEnumerable()];
        List<OrderBy> expectedOriginalItems = [initial];
