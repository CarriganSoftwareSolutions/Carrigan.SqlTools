...
public class IsNotNullTests
{
    ...
    private readonly string ParameterPiSql = "$1";

    private readonly Parameter ParameterElite = new(1337, "Elite");
    private readonly string ParameterEliteSql = "$1";
    ...
    public void IsNotNull_Nested_ToSql()
    {
        ...
        string andSql = $"(($1 IS NOT NULL) AND ($2 IS NOT NULL) AND ({ColumnFutureCitySql} IS NOT NULL) AND ({ColumnDestructCodeSql} IS NOT NULL))";
