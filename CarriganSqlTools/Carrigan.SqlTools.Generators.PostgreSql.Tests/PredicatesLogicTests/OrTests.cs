...
public class OrTests
{
    ...
    public void Or_ToSql()
    {
        ...
        string expected = "(\"LogicalPredicateTable\".\"IsActive\" OR ($1 IS NOT NULL) OR ($2 IS NOT NULL) OR \"LogicalPredicateTable\".\"IsEnabled\" OR (\"LogicalPredicateTable\".\"IsVisible\" AND \"LogicalPredicateTable\".\"IsArchived\" AND ($3 IS NOT NULL)))";
        string actual = or.ToSqlFragments(Dialect).ToSql(Dialect);
