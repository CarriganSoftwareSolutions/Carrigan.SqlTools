...
public sealed class DateFromPartsTests : IClassFixture<BooksFixture>
{
    private readonly BooksFixture _fixture;
    private readonly SqlGenerator<Book> _generator = new();

    public DateFromPartsTests(BooksFixture fixture) => _fixture = fixture;
    ...
    public async Task ExpressionConstructor_Test()
    {
        ...
        (
            new DateFromParts(new Parameter(2026), new Parameter(9), new Parameter(23))
        );
    ...
    {
        IEnumerable<DateOnlyValue> records = await ExecuteAsync(new DateFromParts(2026, 9, 23));
