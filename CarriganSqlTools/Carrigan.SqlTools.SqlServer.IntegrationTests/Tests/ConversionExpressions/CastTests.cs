...
public sealed class CastTests : IClassFixture<BooksFixture>
{
    private readonly BooksFixture _fixture;
    private readonly SqlGenerator<Book> _generator = new();

    public CastTests(BooksFixture fixture) =>
        _fixture = fixture;
    ...
    public async Task ValidConversion_ReturnsConvertedValue()
    {
        ...
        (
            new Cast(new Parameter("123"), SqlServerTypesProvider.AsInt(true))
        );
