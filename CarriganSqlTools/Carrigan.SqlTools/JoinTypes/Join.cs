...
public class Join<rightT> : JoinBase
{
    ...
    /// <summary>
    /// Converts the current <see cref="Join{rightT}"/> instance to its <see cref="ISqlFragment"/> representation.
    /// </summary>
    /// <param name="dialect"></param>
    /// <returns>
    /// A <see cref="ISqlFragment"/> string representing the <c>JOIN</c> clause.
    /// </returns>
