...
/// </summary>
/// <param name="Value">Table name</param>
internal readonly record struct TableName(string Value) : IWhiteSpace
{
    /// <summary>
    /// implicit operator
    /// </summary>
    /// <param name="value">Table name</param>
    public static implicit operator string(TableName name) => 
        name.ToString();
