...
/// ]]></code>
/// </example>
public class ProcedureTag : TextWrapper, ISqlFragment
{
    /// <summary>
    ...
    internal ProcedureTag(SchemaName? schemaName, ProcedureName procedureName)
        : base(schemaName.IsNotNullOrEmpty() ? $"{schemaName}.{procedureName}" : procedureName.ToString(), StringComparison.Ordinal)
    {
