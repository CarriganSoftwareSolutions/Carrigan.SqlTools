...
/// </remarks>
public sealed class AggregateExpressionInWhereClauseException : Exception
{
    /// <summary>
    /// Initializes a new instance of the <see cref="AggregateExpressionInWhereClauseException"/> class.
    /// </summary>
    internal AggregateExpressionInWhereClauseException()
        : base("WHERE clauses cannot contain aggregate expressions. Use HAVING to filter aggregate results.")
    {
    }
}