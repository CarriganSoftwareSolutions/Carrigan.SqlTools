...
namespace Carrigan.SqlTools.PostgreSql.IntegrationTests.Inserts;
...
internal static class Insert
{
    ...
    public static IEnumerable<SqlQuery> LeftInsertStatement =>
        LeftDataSet.Data.Chunk(100).Select(dataSet => new SqlGenerator<LeftWords>().Insert(null, null, dataSet));
    ...
    public static IEnumerable<SqlQuery> RightInsertStatement =>
        RightDataSet.Data.Chunk(100).Select(dataSet => new SqlGenerator<RightWords>().Insert(null, null, dataSet));
}
