...
public class SqlGenerator_SelectTests
{
    ...
    {
        SqlQuery query = _sqlGeneratorForEntityWithTableAttribute.Select(null, null, null, null, OrderBys.Empty, null);
    ...
    {
        SqlQuery query = _sqlGeneratorForEntityWithTableAttribute.Select(false, null, null, null, OrderBys.Empty, null);
    ...
    {
        SqlQuery query = _sqlGeneratorForEntityWithTableAttribute.Select(true, null, null, null, OrderBys.Empty, null);
    ...
    public void SqlSelect_InnerInnerJoin_NoPredicates_WithTableAttribute()
    {
        ...
        SqlQuery query = _sqlGeneratorForJoinLeftTable.Select(null, null, join, null, null, null);
    ...
    public void SqlSelect_NoJoins_WithPredicates_WithTableAttribute()
    {
        ...
        SqlQuery query = _sqlGeneratorForColumnTable.Select(null, null, null, id, null, null);
    ...
    public void SqlSelect_WithInnerJoin_WithPredicates_WithTableAttribute()
    {
        ...
        SqlQuery query = _sqlGeneratorForJoinLeftTable.Select(null, null, relation, predicateId, null, null);
    ...
    public void SqlSelect_WithLeftJoin_WithPredicates_WithTableAttribute()
    {
        ...
        SqlQuery query = _sqlGeneratorForJoinLeftTable.Select(null, null, relations, predicateId, null, null);
    ...
    public void SqlSelect_WithLeftAndInnerJoin_WithPredicates_WithTableAttribute()
    {
        ...
        SqlQuery query = _sqlGeneratorForJoinLeftTable.Select(null, null, joins, predicateId, null, null);
    ...
    public void SqlSelect_WithLeftAndInnerJoin_WithPredicates_WithOrderBy_WithTableAttribute()
    {
        ...
        OrderBys orderBy = new OrderBys(orderByItem1, orderByItem2, orderByItem3);
    ...
    public void SqlSelect_WithLeftAndInnerJoin_WithPredicates_WithOrderByItem_AsOrderByClause_WithTableAttribute()
    {
        ...
        SqlQuery query = _sqlGeneratorForJoinLeftTable.Select(null, null, relation, predicateId, orderByItem, offsetNext);
    ...
    public void SqlSelect_WithDistinctFalse_WithLeftAndInnerJoin_WithPredicates_WithOrderByItem_AsOrderByClause_WithTableAttribute()
    {
        ...
        OrderBy<JoinLeftTable> orderByItem = new("Id", SortDirectionEnum.Ascending);
        DefinePage offsetNext = new(3, 50);
        SqlQuery query = _sqlGeneratorForJoinLeftTable.Select(false, null, relation, predicateId, orderByItem, offsetNext);
    ...
    public void SqlSelect_WithDistinctTrue_WithLeftAndInnerJoin_WithPredicates_WithOrderByItem_AsOrderByClause_WithTableAttribute()
    {
        ...
        OrderBy<JoinLeftTable> orderByItem = new("Id", SortDirectionEnum.Ascending);
        DefinePage offsetNext = new(3, 50);
        SqlQuery query = _sqlGeneratorForJoinLeftTable.Select(true, null, relation, predicateId, orderByItem, offsetNext);
