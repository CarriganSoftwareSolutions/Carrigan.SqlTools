...
public class SqlGenerator_SelectTests
{
    ...
    {
        SqlQuery query = _sqlGeneratorForEntityWithTableAttribute.Select(null, null, null, null, null, OrderBys.Empty, null);
    ...
    {
        SqlQuery query = _sqlGeneratorForEntityWithTableAttribute.Select(false, null,null, null, null, OrderBys.Empty, null);
    ...
    {
        SqlQuery query = _sqlGeneratorForEntityWithTableAttribute.Select(true, null,null, null, null, OrderBys.Empty, null);
    ...
    public void SqlSelect_InnerInnerJoin_NoPredicates_WithTableAttribute()
    {
        ...
        SqlQuery query = _sqlGeneratorForJoinLeftTable.Select(null, null, null, join, null, null, null);
    ...
    public void SqlSelect_NoJoins_WithPredicates_WithTableAttribute()
    {
        ...
        SqlQuery query = _sqlGeneratorForColumnTable.Select(null, null, null, null, id, null, null);
    ...
    public void SqlSelect_WithInnerJoin_WithPredicates_WithTableAttribute()
    {
        ...
        SqlQuery query = _sqlGeneratorForJoinLeftTable.Select(null, null, null, relation, predicateId, null, null);
    ...
    public void SqlSelect_WithLeftJoin_WithPredicates_WithTableAttribute()
    {
        ...
        SqlQuery query = _sqlGeneratorForJoinLeftTable.Select(null, null, null, relations, predicateId, null, null);
    ...
    public void SqlSelect_WithLeftAndInnerJoin_WithPredicates_WithTableAttribute()
    {
        ...
        SqlQuery query = _sqlGeneratorForJoinLeftTable.Select(null, null, null, joins, predicateId, null, null);
    ...
    public void SqlSelect_WithLeftAndInnerJoin_WithPredicates_WithOrderBy_WithTableAttribute()
    {
        ...
        LeftJoin<JoinLastTable> join2 = new(joinId2);
        Joins<JoinLeftTable> joins = new (join1, join2);
        OrderBy<JoinLeftTable> orderByItem1 = new("Id", SortDirectionEnum.Ascending);
        OrderBy<JoinRightTable> orderByItem2 = new("Id", SortDirectionEnum.Descending);
        ...
        SqlQuery query = _sqlGeneratorForJoinLeftTable.Select(null, null, null, joins, predicateId, orderBy, offsetNext);
    ...
    public void SqlSelect_WithLeftAndInnerJoin_WithPredicates_WithOrderByItem_AsOrderByClause_WithTableAttribute()
    {
        ...
        SqlQuery query = _sqlGeneratorForJoinLeftTable.Select(null, null, null, relation, predicateId, orderByItem, offsetNext);
    ...
    [Fact]
    public void SqlSelect_WithDistinctFalse_WithLeftAndInnerJoin_WithPredicates_WithOrderByItem_AsOrderByClause_WithTableAttribute()
    {
        Predicates joinId1 = new Equal(new Column<JoinLeftTable>("RightId"), new Column<JoinRightTable>("Id"));
        Predicates joinId2 = new Equal(new Column<JoinRightTable>("LastId"), new Column<JoinLastTable>("Id"));
        Predicates predicateId = new Equal(new Column<JoinLastTable>("Id"), new Parameter(3, "Id"));
        ...
        OrderBy<JoinLeftTable> orderByItem = new("Id", SortDirectionEnum.Ascending);
        DefinePage offsetNext = new(3, 50);
        SqlQuery query = _sqlGeneratorForJoinLeftTable.Select(false, null,null, relation, predicateId, orderByItem, offsetNext);
    ...
    [Fact]
    public void SqlSelect_WithDistinctTrue_WithLeftAndInnerJoin_WithPredicates_WithOrderByItem_AsOrderByClause_WithTableAttribute()
    {
        Predicates joinId1 = new Equal(new Column<JoinLeftTable>("RightId"), new Column<JoinRightTable>("Id"));
        Predicates joinId2 = new Equal(new Column<JoinRightTable>("LastId"), new Column<JoinLastTable>("Id"));
        Predicates predicateId = new Equal(new Column<JoinLastTable>("Id"), new Parameter(3, "Id"));
        ...
        OrderBy<JoinLeftTable> orderByItem = new("Id", SortDirectionEnum.Ascending);
        DefinePage offsetNext = new(3, 50);
        SqlQuery query = _sqlGeneratorForJoinLeftTable.Select(true, null,null, relation, predicateId, orderByItem, offsetNext);
