...
namespace Carrigan.SqlTools.Generators.SqlServer.Tests.IdentifierTypes;
public class TableNameTests
{
    ...
    {
        TableName? nameWrapper = TableName.New(nul);
    ...
    {
        TableName? nameWrapper = TableName.New(empty);
        Assert.Null(nameWrapper);
    }
    ...
    {
        TableName nameWrapper = new(empty);
    ...
    {
        TableName nameWrapper = new(eStr);
    ...
    public void Equal_Null()
    {
        ...
        TableName nameWrapper1 = new(name);
        TableName nameWrapper2 = new(name);
    ...
    {
        TableName nameWrapper1 = new(eStr);
        TableName nameWrapper2 = new(eStrAlt);
        Assert.Equal(nameWrapper1, nameWrapper2);
    ...
    {
        TableName nameWrapper1 = new(nul);
        TableName nameWrapper2 = new(nul);
    ...
    {
        TableName nameWrapper1 = new(empty);
        TableName nameWrapper2 = new(empty);
        Assert.True(nameWrapper1 == nameWrapper2);
        Assert.True(string.Empty == nameWrapper2);
    }
    ...
    {
        TableName nonNull = new(string.Empty);
        TableName? isNull = null;
    ...
    {
        string? name = null;
        Dictionary<TableName, decimal> dictionary= [];
    ...
    public void DictionaryKey_Multi()
    {
        ...
        TableName nameWrapper1 = new(eStr);
        TableName nameWrapper2 = new(eStrAlt);
        TableName nameWrapper3 = new(tString);
        TableName nameWrapper4 = new(goldenString);
        TableName nameWrapper5 = new(piString);
        TableName nameWrapper6 = new(empty);
    ...
    {
        TableName nameWrapper1 = new(nul);
        TableName nameWrapper2 = new(goldenString);
    ...
    {
        TableName nameWrapper1 = new(nul);
        TableName nameWrapper2 = new(eStr);
        Assert.True(nameWrapper1 != nameWrapper2);
    ...
    public void IsNullOrEmpty_True()
    {
        TableName? nameWrapper1 = new(empty);
        TableName nameWrapper2 = new(nul);
        TableName? nameWrapper3 = null;
        TableName? nameWrapper4 = TableName.New(nul);
        TableName? nameWrapper5 = TableName.New(empty);
    ...
    {
        TableName nameWrapper1 = new(eStr);
        TableName nameWrapper2 = new(white);
    ...
    public void IsNullOrEmpty_False()
    {
        TableName nameWrapper1 = new(eStr);
        TableName nameWrapper2 = new(white);
        TableName? nameWrapper3 = TableName.New(eStr);
        TableName? nameWrapper4 = TableName.New(white);
    ...
    public void IsNotNullOrEmpty_False()
    {
        ...
        TableName nameWrapper2 = new(nul);
        TableName? nameWrapper3 = null;
        TableName? nameWrapper4 = TableName.New(null);
        TableName? nameWrapper5 = TableName.New(nul);
        TableName? nameWrapper6 = TableName.New(empty);
    ...
    public void IsWhitespace_True()
    {
        TableName nameWrapper1 = new(empty);
        TableName nameWrapper2 = new(nul);
        TableName nameWrapper3 = new(white);
    ...
    public void IsNullOrWhitespace_True()
    {
        ...
        TableName nameWrapper2 = new(nul);
        TableName nameWrapper3 = new(white);
        TableName? nameWrapper4 = null;
        TableName? nameWrapper5 = TableName.New(null);
        TableName? nameWrapper6 = TableName.New(nul);
        TableName? nameWrapper7 = TableName.New(empty);
        TableName? nameWrapper8 = TableName.New(white);
    ...
    {
        TableName nameWrapper1 = new(eStr);
        TableName? nameWrapper2 = TableName.New(eStr);
    ...
    public void IsNotNullOrWhitespace_False()
    {
        ...
        TableName? nameWrapper5 = TableName.New(empty);
        TableName? nameWrapper6 = TableName.New(nul);
        TableName? nameWrapper7 = TableName.New(white);
    ...
    {
        TableName left = new("ABC");
        TableName right = new("ABC");
    ...
    {
        TableName left = new("A");
        TableName right = new("B");
